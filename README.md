...
This project does *not* try to be a complete mobile toolkit. It just clones iOS7 elements key to a native feel. It can be used with a responsive front-end framework without unnecessary overlaps. It should remain lightweight and focus only on those key elements. It should not require external libraries outside of the Angular ecosystem (no jQuery for example).
